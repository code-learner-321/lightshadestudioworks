    ...
    <div class="max-w-5xl mx-auto">
        ...
        <header class="mb-10 py-4 text-center">
            <div class="inline-flex items-center gap-2 px-4 py-1.5 mb-5 
                ...
                <?php esc_html_e( 'Category', 'lightshadestudioworks' ); ?>
            </div>
        ...
        <?php else : ?>
            <p class="text-center text-[#000000]/70 dark:text-[#ffffff]/70">
                <?php esc_html_e( 'No posts found in this category.', 'lightshadestudioworks' ); ?>
            </p>
        <?php endif; ?>
